...
class Circle {
  ...
  draw() {
    ...
    for (i = 0; i < this.animations.length; i++) {
      ...
      console.log(p.animation_time, animation_done, this.ctx_prop);
    }
...
class Graph {
  constructor(ani, graph_type = "undirect", layout = "grid", node_radius = 20, gap = 100, num_cols = 4, center_x = 400) {
    this.ani = ani;
  ...
  get_edge(n1, n2, weight = 0) {
    ...
    let id2 = n2.id + "->" + n1.id;
    let e, l;
    if (id in this.edge_map) return this.edge_map[id];
